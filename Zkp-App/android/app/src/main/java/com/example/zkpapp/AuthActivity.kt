...
class AuthActivity : AppCompatActivity() {
    ...
    /**
     * v3.0 — Clean guide dialog
     * No real passport → show guide only + Cancel
     * No confusing Basic Login option
     */
    private fun showClaimUpgradeDialog(
        ...
        val domainShort = domain.take(30)

        runOnUiThread {
            androidx.appcompat.app.AlertDialog.Builder(this)
                .setTitle("⚠️ Passport Required")
                .setMessage(
                    "📌 $domainShort requires $claimLabel verification\n\n" +
                    "┌─────────────────────────┐\n" +
                    "│  This claim needs a     │\n" +
                    "│  real NFC passport      │\n" +
                    "│                         │\n" +
                    ...
                    "│  ③ Come back & scan QR  │\n" +
                    "└─────────────────────────┘\n\n" +
                    "Device-only proof cannot verify $claimLabel."
                )
